...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'/Users/thomas/Downloads/Korpukseen/Manus Plastikkbarna_1.docx'"/>
    ...
    <language xml:lang="fkv"/><language xml:lang="nno"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fkv" location="manus_plastikkbarna_1.docx"/>
