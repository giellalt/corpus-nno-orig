...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/kl06/KRO1-03/Hele/Komplett_visning?lplang=nno&amp;read=1'"/>
    ...
    <parallel_text xml:lang="eng" location="laereplan_kroppsoeving.html"/>
