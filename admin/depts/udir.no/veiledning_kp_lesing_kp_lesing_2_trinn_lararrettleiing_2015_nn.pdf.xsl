...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/kartleggingsprover/larerveiledninger-gs-2015/kp_lesing_2_trinn_lararrettleiing_2015_nn.pdf'"/>
    ...
    <parallel_text xml:lang="nob" location="veiledning_kp_lesing_kp_lesing_2_trinn_larerveiledning_2015_bm.pdf"/>
