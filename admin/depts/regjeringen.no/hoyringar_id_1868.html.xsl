...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/dokument/Hoyringar.html?id=1868'"/>
...
<xsl:variable name="para_nob" select="'horinger.html?id=1868'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horinger_id_1868.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
