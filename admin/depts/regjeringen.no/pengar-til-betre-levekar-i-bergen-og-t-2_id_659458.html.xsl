...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/2011/pengar-til-betre-levekar-i-bergen-og-t-2.html?id=659458'"/>
...
<xsl:variable name="para_eng" select="'money-to-improve-living-conditions-in-be.html_id=659458'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="money-to-improve-living-conditions-in-be_id_659458.html" xml:lang="eng"/>
