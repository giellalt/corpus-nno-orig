...
<xsl:variable name="para_sma" select="'arromelastoeviertieh-prosjektasse-gnest-.html?id=610610'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arromelastoeviertieh-prosjektasse-gnest-_id_610610.html" xml:lang="sma"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
