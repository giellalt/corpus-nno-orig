...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/rundskriv.html?id=1786'"/>
...
<xsl:variable name="para_nob" select="'rundskriv.html?id=1786'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rundskriv_id_1786.html" xml:lang="nob"/>
