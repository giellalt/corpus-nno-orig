...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/havbruksnaringa.html?id=1282'"/>
...
<xsl:variable name="para_nob" select="'akvakultur.html?id=1282'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="akvakultur_id_1282.html" xml:lang="nob"/>
