...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/transportavdelinga-ta/Miljo--og-kollektivtransportseksjonen/Avdelingsdirektor-Anne-Brendemoen.html?id=314115'"/>
...
<xsl:variable name="para_nob" select="'avdelingsdirektor-anne-brendemoen.html?id=314115'"/>
