...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/bestilling-av-publikasjonar.html?id=439327'"/>
...
<xsl:variable name="para_nob" select="'bestilling-av-publikasjoner.html?id=439327'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bestilling-av-publikasjoner_id_439327.html" xml:lang="nob"/>
