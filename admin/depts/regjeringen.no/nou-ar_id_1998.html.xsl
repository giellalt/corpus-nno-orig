...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/dokument/NOU-ar.html?id=1998'"/>
...
<xsl:variable name="para_nob" select="'nou-er.html?id=1998'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nou-er_id_1998.html" xml:lang="nob"/>
