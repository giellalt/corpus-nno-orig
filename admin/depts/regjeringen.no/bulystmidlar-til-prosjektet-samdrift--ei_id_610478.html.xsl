...
<xsl:variable name="para_sma" select="'arromelastoeviertieh-prosjektasse-laaven.html?id=610478'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arromelastoeviertieh-prosjektasse-laaven_id_610478.html" xml:lang="sma"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
