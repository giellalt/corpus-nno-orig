...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/kalender.html?id=524'"/>
...
<xsl:variable name="para_nob" select="'kalender.html?id=524'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kalender_id_524.html" xml:lang="nob"/>
