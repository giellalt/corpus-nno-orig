...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/Mange-kommunar-med-auka-folketal-fyrste-kvartal-2010/Kommunane-far-auka-inntekter-neste-ar.html?id=604561'"/>
...
<xsl:variable name="para_eng" select="'The-municipalities-will-receive-more-income-next-year.html?id=604561'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-municipalities-will-receive-more-income-next-year_id_604561.html" xml:lang="eng"/>
