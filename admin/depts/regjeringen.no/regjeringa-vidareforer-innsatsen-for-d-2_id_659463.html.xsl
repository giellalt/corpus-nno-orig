...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/2011/regjeringa-vidareforer-innsatsen-for-d-2.html?id=659463'"/>
...
<xsl:variable name="para_eng" select="'the-government-continues-its-initiatives.html_id=659463'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-government-continues-its-initiatives_id_659463.html" xml:lang="eng"/>
