...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/Dokument/proposisjonar-og-meldingar/stortingsmeldingar.html?id=578'"/>
...
<xsl:variable name="para_nob" select="'stmeld.html?id=578'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stmeld_id_578.html" xml:lang="nob"/>
