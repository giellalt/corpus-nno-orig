...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsminister/statsminister-jens-stoltenberg/Kalender/2010/hovudavtala.html?id=616358'"/>
<xsl:variable name="title" select="'Hovudavtala mellom LO og NHO 75 år - regjeringen.no'"/>
