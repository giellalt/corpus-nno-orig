...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Veg--og-baneavdelinga-VB/Seksjon-for-trafikktryggleik-og-beredska.html?id=332359'"/>
...
<xsl:variable name="para_nob" select="'trafikksikkerhets--og-beredskapsseksjone.html?id=332359'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trafikksikkerhets--og-beredskapsseksjone_id_332359.html" xml:lang="nob"/>
