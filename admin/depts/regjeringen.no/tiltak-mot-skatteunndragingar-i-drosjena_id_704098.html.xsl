...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/pressemeldingar/2012/tiltak-mot-skatteunndragingar-i-drosjena.html?id=704098'"/>
...
<xsl:variable name="para_nob" select="'tiltak-mot-skatteunndragelser-i-drosjena.html_id=704098'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tiltak-mot-skatteunndragelser-i-drosjena_id_704098.html" xml:lang="nob"/>
