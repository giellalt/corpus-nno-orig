...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Dokument/Hoyringar.html?id=1805'"/>
...
<xsl:variable name="para_nob" select="'hoyringar.html?id=1805'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hoyringar_id_1805.html" xml:lang="nob"/>
