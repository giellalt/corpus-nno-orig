...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar/2013/prosjektmidlar-for-a-rekruttere-fleire-e.html?id=727833'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Prošeaktaruđat dan váste ahte rekrutteret eanet vuorrasiid eaktodáhtolaš bargui - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'regjeringen-satser-nytt-innen-kulturnari.html_id=728123'"/>
<xsl:variable name="para_sma" select="'politiijaielggadeapmi-geigejuvvui-faremo.html_id=730801'"/>
<xsl:variable name="para_sme" select="'proeaktaruat-dan-vaste-ahte-rekrutteret-.html_id=727833'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="proeaktaruat-dan-vaste-ahte-rekrutteret-_id_727833.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
