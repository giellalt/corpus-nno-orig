...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/Hoyringar/Saker-pa-hoyring.html?id=1764'"/>
...
<xsl:variable name="para_nob" select="'paa_hoering.html?id=1764'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="paa_hoering_id_1764.html" xml:lang="nob"/>
