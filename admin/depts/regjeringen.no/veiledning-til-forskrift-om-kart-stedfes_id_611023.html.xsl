...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/dok/veiledninger/2010/veiledning-til-forskrift-om-kart-stedfes.html?id=611023'"/>
...
<xsl:variable name="para_nob" select="'veiledning-til-forskrift-om-kart-stedfes.html?id=611023'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="veiledning-til-forskrift-om-kart-stedfes_id_611023.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
