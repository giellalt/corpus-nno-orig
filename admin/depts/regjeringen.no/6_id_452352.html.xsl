...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20022003/stdie-nr-10-2002-2003-samisk/6/1/6.html?id=452352'"/>
<xsl:variable name="title" select="'1.1.6 Válgabiire 6 áltá/Fálesnuorri - regjeringen.no'"/>
