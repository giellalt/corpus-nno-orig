...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/landbruk-i-kommunane.html?id=1237'"/>
...
<xsl:variable name="para_nob" select="'landbruk_i_kommunene.html?id=1237'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbruk_i_kommunene_id_1237.html" xml:lang="nob"/>
