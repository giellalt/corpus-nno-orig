...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/pressemeldingar/2012/auka-skatteinntekter-til-kommunane-i-201.html?id=701326'"/>
...
<xsl:variable name="para_eng" select="'municipal-tax-revenues-saw-strong-growth.html_id=701326'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="municipal-tax-revenues-saw-strong-growth.html_id=701326" xml:lang="eng"/>
