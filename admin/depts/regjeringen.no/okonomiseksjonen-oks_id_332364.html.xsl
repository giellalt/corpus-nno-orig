...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Plan--okonomi--og-administrasjonsavdelin/Okonomiseksjonen-OKS.html?id=332364'"/>
...
<xsl:variable name="para_nob" select="'okonomiseksjonen-oks.html?id=332364'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okonomiseksjonen-oks_id_332364.html" xml:lang="nob"/>
