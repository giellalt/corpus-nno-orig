...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2012/lover-og-reglar-skal-stotte-digitale-arb.html?id=677964'"/>
...
<xsl:variable name="para_nob" select="'lover-og-regler-skal-stotte-digitale-arb.html_id=677964'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lover-og-regler-skal-stotte-digitale-arb_id_677964.html" xml:lang="nob"/>
