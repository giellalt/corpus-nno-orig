...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/okologisk-matproduksjon.html?id=1272'"/>
...
<xsl:variable name="para_nob" select="'okologisk.html?id=1272'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okologisk_id_1272.html" xml:lang="nob"/>
