...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar.html?id=115207'"/>
...
<xsl:variable name="para_nob" select="'underliggende_etater.html?id=115207'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="underliggende_etater_id_115207.html" xml:lang="nob"/>
