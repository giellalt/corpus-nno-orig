...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/Tidsskrift-og-nyheitsbrev.html?id=1797'"/>
...
<xsl:variable name="para_nob" select="'tidsskrift_nyhetsbrev.html?id=1797'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tidsskrift_nyhetsbrev_id_1797.html" xml:lang="nob"/>
