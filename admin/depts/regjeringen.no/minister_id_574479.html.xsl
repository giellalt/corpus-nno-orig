...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/aktuelt/taler-og-artiklar/minister.html?id=574479'"/>
...
<xsl:variable name="para_nob" select="'minister.html?id=574479'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minister_id_574479.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
