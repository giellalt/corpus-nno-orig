...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2012/styrkjer-arbeidet-med-bevaring-av-kyrkje.html?id=682454'"/>
...
<xsl:variable name="para_nob" select="'styrker-arbeidet-med-bevaring-av-kirkeby.html_id=682454'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="styrker-arbeidet-med-bevaring-av-kirkeby_id_682454.html" xml:lang="nob"/>
