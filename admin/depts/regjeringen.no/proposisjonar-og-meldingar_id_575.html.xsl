...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/Dokument/proposisjonar-og-meldingar.html?id=575'"/>
...
<xsl:variable name="para_nob" select="'regpubl.html?id=575'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regpubl_id_575.html" xml:lang="nob"/>
