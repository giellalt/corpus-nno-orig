...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/pressemeldingar/2012/oecd-sin-landrapport-om-norsk-okonomi.html?id=672434'"/>
...
<xsl:variable name="para_eng" select="'speech-in-connection-with-the-government.html_id=672443'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oecds-landrapport-om-norsk-okonomi_id_672434.html" xml:lang="nob"/>
