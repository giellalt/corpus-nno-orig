...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/internasjonalt-samarbeid-om-landbruk-og-.html?id=1185'"/>
...
<xsl:variable name="para_nob" select="'nternasjonalt_samarbeid_om_mat_og_landbr.html?id=1185'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nternasjonalt_samarbeid_om_mat_og_landbr_id_1185.html" xml:lang="nob"/>
