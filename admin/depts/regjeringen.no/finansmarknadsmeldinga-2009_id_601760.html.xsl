...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/Pressemeldingar/2010/Finansmarknadsmeldinga-2009.html?id=601760'"/>
<xsl:variable name="title" select="'Finánsamárkandieđáhus 2009 - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1058'"/>
...
<xsl:variable name="para_sme" select="'Finansamarkandieahus-2009.html?id=601760'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finansamarkandieahus-2009_id_601760.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
