...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/Sjomat---marknad-og-handel.html?id=1181'"/>
...
<xsl:variable name="para_nob" select="'sjomat_marked_og_handel.html?id=1181'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sjomat_marked_og_handel_id_1181.html" xml:lang="nob"/>
