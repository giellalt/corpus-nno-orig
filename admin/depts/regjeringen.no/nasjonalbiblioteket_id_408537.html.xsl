...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/nasjonalbiblioteket.html?id=408537'"/>
...
<xsl:variable name="para_nob" select="'nasjonalbiblioteket.html?id=408537'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nasjonalbiblioteket_id_408537.html" xml:lang="nob"/>
