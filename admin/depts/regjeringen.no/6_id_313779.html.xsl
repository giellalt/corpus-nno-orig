...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nn/dep/kud/Dokument/proposisjonar-og-meldingar/Odelstingsproposisjonar/20012002/otprp-nr-114-2001-2002-/6.html?id=313779'"/>
...
<xsl:variable name="sub_email" select="'borre.gaup'"/>
...
<xsl:variable name="para_sme" select="'4.html?id=170408'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="4.html_id=170408" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
