...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/presse.html?id=439462'"/>
...
<xsl:variable name="para_nob" select="'presse.html?id=439462'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="presse_id_439462.html" xml:lang="nob"/>
