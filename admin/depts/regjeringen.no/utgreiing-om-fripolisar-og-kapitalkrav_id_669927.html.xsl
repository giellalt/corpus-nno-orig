...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/pressemeldingar/2012/utgreiing-om-fripolisar-og-kapitalkrav.html?id=669927'"/>
...
<xsl:variable name="para_nob" select="'utredning-om-fripoliser-og-kapitalkrav.html_id=669927'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utredning-om-fripoliser-og-kapitalkrav_id_669927.html" xml:lang="nob"/>
