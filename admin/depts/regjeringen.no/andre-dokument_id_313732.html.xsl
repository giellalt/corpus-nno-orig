...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Dokument/Andre-dokument.html?id=313732'"/>
...
<xsl:variable name="para_nob" select="'andre.html?id=313732'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="andre_id_313732.html" xml:lang="nob"/>
