...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20022003/stdie-nr-10-2002-2003-samisk/6/1/8.html?id=452354'"/>
<xsl:variable name="title" select="'1.1.8 Válgabiire 8 Gasku-Romsa - regjeringen.no'"/>
