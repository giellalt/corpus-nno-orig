...
<xsl:variable name="title" select="'Etterbetaling av kompensasjon for bortfall av automatinntekter til Norges Blindeforbund og Norsk Folkehjelp - regjeringen.no'"/>
