...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/genmodifiserte-organismar.html?id=1274'"/>
...
<xsl:variable name="para_nob" select="'genmodifiserte_organismer.html?id=1274'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="genmodifiserte_organismer_id_1274.html" xml:lang="nob"/>
