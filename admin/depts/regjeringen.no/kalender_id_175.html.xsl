...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/aktuelt/kalender.html?id=175'"/>
...
<xsl:variable name="para_nob" select="'kalender.html?id=175'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kalender_id_175.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
