...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar.html?id=564'"/>
...
<xsl:variable name="para_nob" select="'pressemeldinger.html?id=564'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pressemeldinger_id_564.html" xml:lang="nob"/>
