...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/pressesenter/Pressemeldingar/2012/endringar-blant-statssekretarane4.html?id=699576'"/>
...
<xsl:variable name="para_eng" select="'changes-among-the-state-secretaries8.html_id=699576'"/>
