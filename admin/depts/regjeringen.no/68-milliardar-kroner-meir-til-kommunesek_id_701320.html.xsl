...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/pressemeldingar/2012/68-milliardar-kroner-meir-til-kommunesek.html?id=701320'"/>
...
<xsl:variable name="para_eng" select="'nok-68-billion-more-to-the-municipal-sec.html_id=701320'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nok-68-billion-more-to-the-municipal-sec_id_701320.html" xml:lang="eng"/>
