...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/Tilknytta-verksemder.html?id=87142'"/>
...
<xsl:variable name="para_nob" select="'tilknyttede_virksomheter.html?id=87142'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tilknyttede_virksomheter_id_87142.html" xml:lang="nob"/>
