...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/likestilling-i-landbruket.html?id=955'"/>
...
<xsl:variable name="para_nob" select="'likestilling_i_landbruket.html?id=955'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="likestilling_i_landbruket_id_955.html" xml:lang="nob"/>
