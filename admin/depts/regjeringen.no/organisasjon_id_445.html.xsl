...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/hod/Om-departementet/organisasjon.html?id=445'"/>
...
<xsl:variable name="para_nob" select="'org.html?id=445'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="org_id_445.html" xml:lang="nob"/>
