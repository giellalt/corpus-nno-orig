...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/sametingsvalg/570159.html?id=570159'"/>
...
<xsl:variable name="para_nob" select="'stemmerett-og-manntall-ved-sametingsvalg.html?id=570159'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stemmerett-og-manntall-ved-sametingsvalg_id_570159.html" xml:lang="nob"/>
