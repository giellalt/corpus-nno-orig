...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/reindrift/Rettleiingar-og-brosjyrar.html?id=86838'"/>
...
<xsl:variable name="para_nob" select="'brosjyrer-og-veiledninger.html?id=86838'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="brosjyrer-og-veiledninger_id_86838.html" xml:lang="nob"/>
