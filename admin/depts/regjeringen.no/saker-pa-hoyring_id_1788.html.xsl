...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/Hoyringar/Saker-pa-hoyring.html?id=1788'"/>
...
<xsl:variable name="para_nob" select="'paa_hoering.html?id=1788'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="paa_hoering_id_1788.html" xml:lang="nob"/>
