...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valg/for-valgmedarbeidere/rapporter.html?id=458184'"/>
...
<xsl:variable name="para_nob" select="'rapporter.html?id=458184'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapporter_id_458184.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
