...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/Hoyringar/Saker-under-behandling.html?id=1765'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="under_behandling_id_1765.html" xml:lang="nob"/>
