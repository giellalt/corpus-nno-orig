...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/2012/naringsfond-styrker-lokal-narings--og-sa.html?id=671750'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ealáhusfoanda nanne báikkálaš ealáhus- ja servodatovddideami - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'state-and-municipality--governance-and-i.html_id=672115'"/>
...
<xsl:variable name="para_nob" select="'flere-nye-prester---lavt-sykefravar.html_id=671798'"/>
<xsl:variable name="para_sma" select="'giske-eun-jielemeministerh-gaavnesji.html_id=672425'"/>
<xsl:variable name="para_sme" select="'ealahusfoanda-nanne-baikkala-ealahus--ja.html_id=671750'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ealahusfoanda-nanne-baikkala-ealahus--ja_id_671750.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
