...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/2011/auka-skatteinntekter-til-kommunane-i-201.html?id=660065'"/>
...
<xsl:variable name="para_eng" select="'increased-tax-revenues-for-local-authori.html_id=660065'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="increased-tax-revenues-for-local-authori_id_660065.html" xml:lang="eng"/>
