...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/pressemeldingar/2011/nytt-hovudstyre-i-noregs-bank.html?id=664718'"/>
...
<xsl:variable name="para_nob" select="'oppnevninger-til-norges-banks-hovedstyre.html_id=664718'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oppnevninger-til-norges-banks-hovedstyre_id_664718.html" xml:lang="nob"/>
