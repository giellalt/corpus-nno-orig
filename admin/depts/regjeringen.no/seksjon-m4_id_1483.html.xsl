...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/Medieavdelinga/Seksjon-M4.html?id=1483'"/>
...
<xsl:variable name="para_nob" select="'juridisk_seksjon.html?id=1483'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="juridisk_seksjon_id_1483.html" xml:lang="nob"/>
