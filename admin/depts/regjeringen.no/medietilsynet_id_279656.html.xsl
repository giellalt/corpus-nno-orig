...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/medietilsynet.html?id=279656'"/>
...
<xsl:variable name="para_nob" select="'medietilsynet.html?id=279656'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="medietilsynet_id_279656.html" xml:lang="nob"/>
