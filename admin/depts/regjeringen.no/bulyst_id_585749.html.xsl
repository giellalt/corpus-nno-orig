...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Tema/regional-_og_distriktspolitikk/levende-og-attraktive-lokalsamfunn/bulyst.html?id=585749'"/>
<xsl:variable name="title" select="'Ássanmiella - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'assanmiella.html?id=585749'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="assanmiella_id_585749.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
