...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/kunst-i-offentlege-rom-koro.html?id=408528'"/>
...
<xsl:variable name="para_nob" select="'utsmykkingsfondet-for-offentlige-bygg.html?id=408528'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utsmykkingsfondet-for-offentlige-bygg_id_408528.html" xml:lang="nob"/>
