...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/jordbruksoppgjeret.html?id=1287'"/>
...
<xsl:variable name="para_nob" select="'jordbruksoppgjoret.html?id=1287'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jordbruksoppgjoret_id_1287.html" xml:lang="nob"/>
