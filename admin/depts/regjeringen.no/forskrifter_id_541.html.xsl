...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Lover-og-reglar/Forskrifter.html?id=541'"/>
...
<xsl:variable name="para_nob" select="'forskrifter.html?id=541'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrifter_id_541.html" xml:lang="nob"/>
