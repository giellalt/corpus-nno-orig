...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/mat.html?id=1270'"/>
...
<xsl:variable name="para_nob" select="'mat.html?id=1270'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mat_id_1270.html" xml:lang="nob"/>
...
=======
               <xsl:with-param name="target" select="'”grønne byer���/'"/>
               <xsl:with-param name="replacement" select="'«grønne byer»/'"/>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
