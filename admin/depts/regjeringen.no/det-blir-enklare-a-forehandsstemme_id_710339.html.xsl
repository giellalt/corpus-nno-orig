...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/pressemeldingar/2012/det-blir-enklare-a-forehandsstemme.html?id=710339'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Šaddá álkibut ovdagihtii jienastit - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1078'"/>
...
<xsl:variable name="para_sme" select="'adda-alkibut-ovdagihtii-jienastit.html_id=710339'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="adda-alkibut-ovdagihtii-jienastit_id_710339.html" xml:lang="sme"/>
