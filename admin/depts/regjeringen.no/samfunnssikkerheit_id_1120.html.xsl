...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/samfunnssikkerheit.html?id=1120'"/>
...
<xsl:variable name="para_nob" select="'samfunnssikkerhet.html?id=1120'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samfunnssikkerhet_id_1120.html" xml:lang="nob"/>
