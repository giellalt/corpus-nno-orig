...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2012/raskare-klagebehandling-i-klagenemnda-fo.html?id=682461'"/>
...
<xsl:variable name="para_nob" select="'raskere-klagebehandling-i-klagenemnda-fo.html_id=682461'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="raskere-klagebehandling-i-klagenemnda-fo_id_682461.html" xml:lang="nob"/>
