...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/proposisjonar-og-meldingar/stortingsmeldingar.html?id=198'"/>
...
<xsl:variable name="para_nob" select="'stmeld.html?id=198'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stmeld_id_198.html" xml:lang="nob"/>
