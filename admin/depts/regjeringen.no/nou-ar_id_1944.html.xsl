...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/NOU-ar.html?id=1944'"/>
...
<xsl:variable name="para_nob" select="'nouer.html?id=1944'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nouer_id_1944.html" xml:lang="nob"/>
