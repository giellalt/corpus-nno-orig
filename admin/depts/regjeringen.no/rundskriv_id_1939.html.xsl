...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Rundskriv.html?id=1939'"/>
...
<xsl:variable name="para_nob" select="'rundskriv.html?id=1939'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rundskriv_id_1939.html" xml:lang="nob"/>
