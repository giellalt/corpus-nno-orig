...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/pressemeldingar/2012/ein-offensiv-og-framtidsretta-bustadpoli.html?id=701294'"/>
...
<xsl:variable name="para_eng" select="'a-pro-active-and-forward-looking-housing.html_id=701294'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="a-pro-active-and-forward-looking-housing_id_701294.html" xml:lang="eng"/>
