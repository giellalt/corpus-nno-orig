...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/pressemeldingar/2012/god-utvikling-i-norsk-okonomi.html?id=682404'"/>
...
<xsl:variable name="wordcount" select="'1481'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="revised-national-budget-2012.html_id=682404" xml:lang="eng"/>
