...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/jordbruk.html?id=1286'"/>
...
<xsl:variable name="para_nob" select="'jordbruk.html?id=1286'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jordbruk_id_1286.html" xml:lang="nob"/>
