...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Luft--post--og-teleavdelinga/Luftfartsseksjonen.html?id=332354'"/>
...
<xsl:variable name="para_nob" select="'luftfartsseksjonen-ls.html?id=332354'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="luftfartsseksjonen-ls_id_332354.html" xml:lang="nob"/>
