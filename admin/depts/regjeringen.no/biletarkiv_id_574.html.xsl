...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/Biletarkiv.html?id=574'"/>
...
<xsl:variable name="para_nob" select="'bildearkiv.html?id=574'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bildearkiv_id_574.html" xml:lang="nob"/>
