...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/Fiske-og-fangst/fiskeflaten.html?id=1279'"/>
...
<xsl:variable name="para_nob" select="'fiskeflaten.html?id=1279'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fiskeflaten_id_1279.html" xml:lang="nob"/>
