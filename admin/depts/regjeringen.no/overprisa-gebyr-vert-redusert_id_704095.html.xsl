...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/pressemeldingar/2012/overprisa-gebyr-vert-redusert.html?id=704095'"/>
...
<xsl:variable name="para_nob" select="'overprisede-gebyrer-reduseres.html_id=704095'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="overprisede-gebyrer-reduseres_id_704095.html" xml:lang="nob"/>
