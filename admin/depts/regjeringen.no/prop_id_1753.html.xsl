...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/proposisjonar-og-meldingar/prop.html?id=1753'"/>
...
<xsl:variable name="para_nob" select="'prop.html?id=1753'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="prop_id_1753.html" xml:lang="nob"/>
