...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/kontakt/Telefonliste.html?id=272488'"/>
...
<xsl:variable name="wordcount" select="'804'"/>
...
<xsl:variable name="para_nob" select="'telefonliste.html?id=272488'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="telefonliste_id_272488.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
