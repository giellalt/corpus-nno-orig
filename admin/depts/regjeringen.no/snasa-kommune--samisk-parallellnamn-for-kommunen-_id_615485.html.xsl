...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/Mange-kommunar-med-auka-folketal-fyrste-kvartal-2010/Snasa-kommune--samisk-parallellnamn-for-kommunen-.html?id=615485'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Snåsa kommune – samisk parallellnamn for kommunen  - regjeringen.no'"/>
=======
...
<xsl:variable name="parallels">
	<parallel_text location="snaasen-tjielte--tjielten-saemien-baalte_id_615485.html" xml:lang="sma"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
