...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/pressemeldingar/2012/27-milliardar-kroner-til-distrikts--og-r.html?id=701135'"/>
...
<xsl:variable name="para_eng" select="'nok-27-billion-allocated-to-local-and-re.html_id=701135'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nok-27-billion-allocated-to-local-and-re_id_701135.html" xml:lang="eng"/>
