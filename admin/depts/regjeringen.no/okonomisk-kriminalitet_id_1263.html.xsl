...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Lov-og-rett/Kriminalitet-og-overgrep/Okonomisk-kriminalitet.html?id=1263'"/>
...
<xsl:variable name="para_nob" select="'okonomisk_kriminalitet.html?id=1263'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okonomisk_kriminalitet_id_1263.html" xml:lang="nob"/>
