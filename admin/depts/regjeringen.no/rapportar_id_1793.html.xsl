...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/rapportar-og-planer/rapportar.html?id=1793'"/>
...
<xsl:variable name="para_nob" select="'rapporter.html?id=1793'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapporter_id_1793.html" xml:lang="nob"/>
