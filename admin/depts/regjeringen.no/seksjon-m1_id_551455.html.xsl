...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/Medieavdelinga/Seksjon-M1.html?id=551455'"/>
...
<xsl:variable name="para_nob" select="'forste-medieseksjon-m1.html?id=551455'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forste-medieseksjon-m1_id_551455.html" xml:lang="nob"/>
