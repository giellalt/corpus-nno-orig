...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/pressemeldingar/2011/oppdaterte-budsjettal-for-2011.html?id=665424'"/>
...
<xsl:variable name="para_nob" select="'oppdaterte-budsjettall-for-2011.html_id=665424'"/>
