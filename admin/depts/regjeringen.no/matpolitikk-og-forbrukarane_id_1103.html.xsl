...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/mat/matpolitikk-og-forbrukarane.html?id=1103'"/>
...
<xsl:variable name="para_nob" select="'forbruker_bolig_og_eiendom.html?id=1103'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forbruker_bolig_og_eiendom_id_1103.html" xml:lang="nob"/>
