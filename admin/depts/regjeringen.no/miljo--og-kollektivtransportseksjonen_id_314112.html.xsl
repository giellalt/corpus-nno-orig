...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/transportavdelinga-ta/Miljo--og-kollektivtransportseksjonen.html?id=314112'"/>
...
<xsl:variable name="para_nob" select="'miljo--og-kollektivtransportseksjonen.html?id=314112'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="miljo--og-kollektivtransportseksjonen_id_314112.html" xml:lang="nob"/>
