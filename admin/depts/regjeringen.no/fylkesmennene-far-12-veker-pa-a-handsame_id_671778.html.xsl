...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/2012/fylkesmennene-far-12-veker-pa-a-handsame.html?id=671778'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Fylkkamánnit ožžot 12 vahku meannudit huksenváidagiid - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'veileder-organisering-staten.html_id=671926'"/>
<xsl:variable name="para_sma" select="'giske-eun-jielemeministerh-gaavnesji.html_id=672425'"/>
<xsl:variable name="para_sme" select="'fylkkamannit-oot-12-vahku-meannudit-huks.html_id=671778'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fylkkamannit-oot-12-vahku-meannudit-huks_id_671778.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
