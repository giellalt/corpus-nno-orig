...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/Trygg-sjomat.html?id=1273'"/>
...
<xsl:variable name="para_nob" select="'trygg_og_sunn_sjomat.html?id=1273'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trygg_og_sunn_sjomat_id_1273.html" xml:lang="nob"/>
