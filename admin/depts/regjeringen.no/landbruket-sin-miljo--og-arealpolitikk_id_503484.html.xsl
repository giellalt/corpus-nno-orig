...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/landbruket-sin-miljo--og-arealpolitikk.html?id=503484'"/>
...
<xsl:variable name="para_nob" select="'landbrukets-miljo--og-arealpolitikk.html?id=503484'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbrukets-miljo--og-arealpolitikk_id_503484.html" xml:lang="nob"/>
