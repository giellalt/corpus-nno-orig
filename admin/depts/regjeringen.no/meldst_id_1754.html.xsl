...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/proposisjonar-og-meldingar/meldst.html?id=1754'"/>
...
<xsl:variable name="para_nob" select="'meldst.html?id=1754'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="meldst_id_1754.html" xml:lang="nob"/>
