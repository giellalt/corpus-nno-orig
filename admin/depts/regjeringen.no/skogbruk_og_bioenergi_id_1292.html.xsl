...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/skogbruk_og_bioenergi.html?id=1292'"/>
...
<xsl:variable name="para_nob" select="'skogbruk_og_bioenergi.html?id=1292'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skogbruk_og_bioenergi_id_1292.html" xml:lang="nob"/>
