...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2012/vil-ha-fleire-som-tilbyr-elektronisk-id.html?id=677965'"/>
...
<xsl:variable name="para_nob" select="'onsker-flere-tilbydere-av-elektronisk-id.html_id=677965'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="onsker-flere-tilbydere-av-elektronisk-id_id_677965.html" xml:lang="nob"/>
