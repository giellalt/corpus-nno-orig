...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/abm-utvikling.html?id=382397'"/>
...
<xsl:variable name="para_nob" select="'abm-utvikling.html?id=382397'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="abm-utvikling_id_382397.html" xml:lang="nob"/>
