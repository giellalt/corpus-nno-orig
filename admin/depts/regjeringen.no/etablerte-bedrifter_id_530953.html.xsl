...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Tema/regional-_og_distriktspolitikk/utvikling-av-bedrifter-og-naringsmiljo/etablerte-bedrifter.html?id=530953'"/>
...
<xsl:variable name="para_eng" select="'established-companies.html?id=530953'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="established-companies_id_530953.html" xml:lang="eng"/>
