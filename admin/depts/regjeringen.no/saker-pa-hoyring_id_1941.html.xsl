...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Hoyringar/Saker-pa-hoyring.html?id=1941'"/>
...
<xsl:variable name="para_nob" select="'paa_hoering.html?id=1941'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="paa_hoering_id_1941.html" xml:lang="nob"/>
