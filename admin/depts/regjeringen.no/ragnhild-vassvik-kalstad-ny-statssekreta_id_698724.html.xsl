...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2012/ragnhild-vassvik-kalstad-ny-statssekreta.html?id=698724'"/>
...
<xsl:variable name="para_nob" select="'ragnhild-vassvik-kalstad-ny-statssekreta.html_id=698724'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ragnhild-vassvik-kalstad-ny-statssekreta_id_698724.html" xml:lang="nob"/>
