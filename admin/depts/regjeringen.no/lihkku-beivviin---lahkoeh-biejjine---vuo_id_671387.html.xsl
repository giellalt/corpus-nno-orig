...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2012/lihkku-beivviin---lahkoeh-biejjine---vuo.html?id=671387'"/>
    ...
    <language xml:lang="sma"/><language xml:lang="sme"/><language xml:lang="smj"/></xsl:variable>
