...
<xsl:variable name="para_sma" select="'Arromelastoeviertieh-prosjektasse--Laavlomefaamoe-Berlevagesne.html?id=609232'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arromelastoeviertieh-prosjektasse--laavlomefaamoe-berlevagesne_id_609232.html" xml:lang="sma"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
