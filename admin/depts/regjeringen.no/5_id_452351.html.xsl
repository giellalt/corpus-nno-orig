...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20022003/stdie-nr-10-2002-2003-samisk/6/1/5.html?id=452351'"/>
<xsl:variable name="title" select="'1.1.5 Válgabiire 5 Porsáŋgu - regjeringen.no'"/>
