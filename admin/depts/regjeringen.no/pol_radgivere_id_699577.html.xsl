...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/pressesenter/Pressemeldingar/2012/pol_radgivere.html?id=699577'"/>
...
<xsl:variable name="para_eng" select="'changes-among-the-political-advisers3.html_id=699577'"/>
