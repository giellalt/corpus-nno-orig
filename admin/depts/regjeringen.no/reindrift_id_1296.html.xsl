...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/reindrift.html?id=1296'"/>
...
<xsl:variable name="para_nob" select="'reindrift.html?id=1296'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindrift_id_1296.html" xml:lang="nob"/>
