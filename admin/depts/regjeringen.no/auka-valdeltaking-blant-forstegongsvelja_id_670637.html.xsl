...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/2012/auka-valdeltaking-blant-forstegongsvelja.html?id=670637'"/>
...
<xsl:variable name="para_eng" select="'higher-turnout-among-first-time-voters.html_id=670637'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="higher-turnout-among-first-time-voters_id_670637.html" xml:lang="eng"/>
