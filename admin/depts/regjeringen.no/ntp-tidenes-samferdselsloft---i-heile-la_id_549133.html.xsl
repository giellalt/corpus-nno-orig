...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/pressesenter/pressemeldingar/2009/ntp-tidenes-samferdselsloft---i-heile-la.html?id=549133'"/>
...
<xsl:variable name="para_eng" select="'unprecedented-boost-for-transport--natio.html?id=549133'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="unprecedented-boost-for-transport--natio_id_549133.html" xml:lang="eng"/>
