...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/plantar.html?id=1293'"/>
...
<xsl:variable name="para_nob" select="'planter.html?id=1293'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="planter_id_1293.html" xml:lang="nob"/>
