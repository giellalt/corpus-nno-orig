...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/Om-nettstaden.html?id=450429'"/>
...
<xsl:variable name="para_nob" select="'Om-nettstedet.html?id=450429'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="om-nettstedet_id_450429.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
