...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/pressemeldingar/2012/forenkling-og-kompetanseutvikling-i-bygg.html?id=701295'"/>
...
<xsl:variable name="para_eng" select="'simplification-and-expertise-development.html_id=701295'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="simplification-and-expertise-development_id_701295.html" xml:lang="eng"/>
