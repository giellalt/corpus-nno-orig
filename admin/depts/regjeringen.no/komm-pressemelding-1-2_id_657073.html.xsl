...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/2011/komm-pressemelding-1-2.html?id=657073'"/>
...
<xsl:variable name="para_eng" select="'nok-56-billion-for-municipal-interaction.html_id=657073'"/>
