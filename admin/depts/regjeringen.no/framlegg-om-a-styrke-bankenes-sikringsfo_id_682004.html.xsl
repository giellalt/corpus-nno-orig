...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/pressemeldingar/2012/framlegg-om-a-styrke-bankenes-sikringsfo.html?id=682004'"/>
...
<xsl:variable name="para_nob" select="'foreslar-a-styrke-bankenes-sikringsfond.html_id=682004'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="foreslar-a-styrke-bankenes-sikringsfond_id_682004.html" xml:lang="nob"/>
