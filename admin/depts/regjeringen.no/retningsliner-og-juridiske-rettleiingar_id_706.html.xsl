...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/dokument/lover-og-reglar/Retningsliner-og-juridiske-rettleiingar.html?id=706'"/>
...
<xsl:variable name="para_nob" select="'retningslinjer.html?id=706'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="retningslinjer_id_706.html" xml:lang="nob"/>
