...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar/2014/kulturdepartementet-innforer-ny-gavefors.html?id=751744'"/>
...
<xsl:variable name="wordcount" select="'745'"/>
...
<xsl:variable name="para_nob" select="'kulturkort-for-ungdom-2014.html_id=751714'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Kulturdepartemeanta-asaha-oa-10-miljovdna-sturrosa-skeakadoarjjaortnega.html_id=751744'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kulturkort-for-ungdom-2014_id_751714.html" xml:lang="nob"/>
	<parallel_text location="kulturdepartemeanta-asaha-oa-10-miljovdna-sturrosa-skeakadoarjjaortnega_id_751744.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 59960224b4 (Norwegian Nynorsk regjeringen.no docs renamed, metadata updated in parallel files)
