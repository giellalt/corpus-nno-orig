...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/pressemeldingar/2012/omregistreringsavgifta-vert-kraftig-redu.html?id=704096'"/>
...
<xsl:variable name="para_nob" select="'omregistreringsavgiften-reduseres-krafti.html_id=704096'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="omregistreringsavgiften-reduseres-krafti_id_704096.html" xml:lang="nob"/>
