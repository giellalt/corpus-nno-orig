...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2011/skjerpa-handheving-av-offentlege-innkjop.html?id=662949'"/>
...
<xsl:variable name="para_eng" select="'stricter-enforcement-of-public-procureme.html_id=662949'"/>
