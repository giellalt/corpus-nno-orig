...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'albert_n.html'"/>
  <xsl:variable name="title" select="'Albert J&#xE5;ma:'"/>
  ...
  <xsl:variable name="year" select="'2995'"/>
  <xsl:variable name="ISBN" select="''"/>
  <xsl:variable name="ISSN" select="''"/>
  <xsl:variable name="place" select="'http://girji.info/skolehist/albert-n.htm'"/>
