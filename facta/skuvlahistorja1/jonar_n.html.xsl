...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'jonar_n.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jonar Thomasson:'"/>
    <!--
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Jonar'"/>
    <xsl:variable name="author2_ln" select="'Thomasson'"/>
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/jonar-n.htm'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="jonar-s.html"/>
        <parallel_text xml:lang="sme" location="jonar-sn.html"/>
