...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/paula-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Oppvokst på ei løgn!'"/>
<xsl:variable name="author1_fn" select="'Paula'"/>
<xsl:variable name="author1_ln" select="'Simonsen'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="paula_s.html" xml:lang="sme"/>
</xsl:variable>
