...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'anita_n.html'"/>
  <xsl:variable name="title" select="'Anita Lervoll'"/>
  <xsl:variable name="author1_fn" select="'Anita'"/>
  <xsl:variable name="author1_ln" select="'Lervoll'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/anita-n.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'3170'"/>
