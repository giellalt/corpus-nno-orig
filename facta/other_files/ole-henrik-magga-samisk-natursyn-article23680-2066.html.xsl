...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://naturvernforbundet.no/finnmark/informasjon-til-organisasjonen/ole-henrik-magga-samisk-natursyn-article23680-2066.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ole Henrik Magga: Samisk natursyn'"/>
    <!--
    ...
    <xsl:variable name="author1_born" select="'19470612'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="olehenrik-magga-sami-luondduoaidnu-article23679-2066.html"/>
