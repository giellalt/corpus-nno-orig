...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/eittrom-n.htm'"/>
<xsl:variable name="title" select="'Reindriftsskole på eitt rom'"/>
...
<xsl:variable name="wordcount" select="'1050'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eittrom-s.html" xml:lang="sme"/>
</xsl:variable>
