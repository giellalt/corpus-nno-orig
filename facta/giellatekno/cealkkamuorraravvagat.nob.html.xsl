...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://oahpa.no/sme/usevisl/cealkkamuorraravvagat.nob.html'"/>
...
<parallel_text location="cealkkamuorraravvagat.eng.html" xml:lang="eng"/>
</xsl:variable>
