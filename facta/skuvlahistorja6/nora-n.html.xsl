...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/nora-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sørsamisk fra førskole til høgskole'"/>
<xsl:variable name="author1_fn" select="'Nora Marie'"/>
<xsl:variable name="author1_ln" select="'Bransfjell'"/>
...
<xsl:variable name="author2_born" select="'1950'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nora-s.html" xml:lang="sma"/>
</xsl:variable>
