...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/stig-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Rettsforfølgd etter ønske om samiskopplæring'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stig-s.html" xml:lang="smj"/>
</xsl:variable>
