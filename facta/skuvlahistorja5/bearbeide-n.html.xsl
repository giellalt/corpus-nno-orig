...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/bearbeide-n.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'« – Bearbeide et gjenstridig folk» – Skolen i Finnmark under krigen'"/>
    <!--
    ...
    <language xml:lang="sme"/><language xml:lang="nno"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="bearbeide-s.html"/>
