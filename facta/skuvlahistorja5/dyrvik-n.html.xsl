...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/dyrvik-s.htm'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Norvald'"/>
    <xsl:variable name="author1_ln" select="'Dyrvik'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1906'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="dyrvik-s.html"/>
