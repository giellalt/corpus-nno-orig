...
<xsl:variable name="filename" select="'http://www.nav.no/Familie/Enslig+mor+eller+far/Enslig+mor+eller+far/805345243.cms'"/>
...
<xsl:variable name="para_nob" select="'Oversikt+over+stønader+og+vilkår.html'"/>
