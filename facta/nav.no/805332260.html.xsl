...
<xsl:variable name="filename" select="'http://www.nav.no/Arbeid/Arbeidssøker/Inntektssikring/Lønnsgaranti/Lønnsgaranti/805332260.cms'"/>
...
<xsl:variable name="wordcount" select="'884'"/>
