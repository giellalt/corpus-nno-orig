...
<xsl:variable name="filename" select="'http://www.nav.no/Familie/Svangerskap,+fødsel+og+adopsjon/Foreldrepenger+ved+adopsjon/Foreldrepenger+ved+adopsjon/805322311.cms'"/>
...
<xsl:variable name="wordcount" select="'1269'"/>
