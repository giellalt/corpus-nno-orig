...
<xsl:variable name="filename" select="'http://www.nav.no/Familie/Barnebidrag/Bidragsforskudd/Bidragsforskudd/1073749124.cms'"/>
...
<xsl:variable name="wordcount" select="'1083'"/>
...
<xsl:variable name="para_sme" select="'229542.html'"/>
