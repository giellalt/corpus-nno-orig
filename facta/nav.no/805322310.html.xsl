...
<xsl:variable name="filename" select="'http://www.nav.no/Familie/Svangerskap,+fødsel+og+adopsjon/Foreldrepenger+ved+fødsel/Foreldrepenger+ved+fødsel/805322310.cms'"/>
...
<xsl:variable name="wordcount" select="'1244'"/>
