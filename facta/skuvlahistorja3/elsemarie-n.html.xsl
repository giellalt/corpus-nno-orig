...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/elsemarie-s.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Innføringa av dagens nordsamiske skrivemåte i skolen'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Else Marie'"/>
    <xsl:variable name="author1_ln" select="'Isaksen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'1674'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="elsemarie-s.html"/>
