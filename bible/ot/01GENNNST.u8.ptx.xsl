...
<!-- Add the metainformation manually -->  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="'01GENNNST.u8.PTX'" name="filename" />
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="'Det gamle testamentet'" name="title" />
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="''" name="author1_fn" />
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="''" name="author1_ln" />
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="'unknown'" name="author1_gender" />
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="''" name="author1_born" />
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="''" name="author1_nat" />
  ...
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="''" name="year" />
  ...
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="'bible'" name="genre" />
  ...
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="'standard'" name="license_type" />
  ...
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="' 1.9 '" name="template_version" />
  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="'$Revision: 1.1 $'" name="current_version" />
<!-- The main language of the document -->  <xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="'nno'" name="mainlang" />
