...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="6_samegiella_manaidgarddiin.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'11, 13'"/>
    ...
    <xsl:variable name="top_margin" select="'3=65, 6=41, 7=26, 10=45, 12=30'"/>
    <xsl:variable name="bottom_margin" select="'2=15, 4=38, 5=83'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'4=7, 7=7, 8=7, 9=7, 12=7'"/>
    <xsl:variable name="inner_left_margin" select="'4=7, 7=7, 8=7, 9=7, 12=7'"/>
    <xsl:variable name="inner_top_margin" select="'4=26, 7=52, 8=24, 9=14, 12=52'"/>
    <xsl:variable name="inner_bottom_margin" select="'4=50, 7=28, 8=55, 9=53, 12=33'"/>
