...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/2._samisk_naringsutvikling.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Næringsutvikling innanfor STN- området på 2000-talet'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="2_sed_guovllu_ealahusovdaneapmi.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 27'"/>
    ...
    <xsl:variable name="top_margin" select="'7=33, 15=48, 17=32'"/>
    <xsl:variable name="bottom_margin" select="'2=17, 3=26, 5=26, 6=50, 7=20, 11=13, 16=13, 18=13, 19=15, 20=87, 21=13, 26=70'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'10=7, 12=7, 21=7, 24=7'"/>
    <xsl:variable name="inner_left_margin" select="'10=7, 12=7, 21=7, 24=7'"/>
    <xsl:variable name="inner_top_margin" select="'10=22, 12=34, 21=37, 24=33'"/>
    <xsl:variable name="inner_bottom_margin" select="'10=31, 12=30, 21=33, 24=34'"/>
