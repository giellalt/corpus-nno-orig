...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel2.alvorleg_nedgang_for_faget_samisk_som_andresprak.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Alvorleg nedgang for faget samisk som andrespråk'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="2.samegiella_skuvllas.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'14, 21'"/>
    ...
    <xsl:variable name="top_margin" select="'3=28, 4=72, 5=77, 8=34, 9=34, 10=25, 13=33'"/>
    <xsl:variable name="bottom_margin" select="'all=14, 6=70, 5=10, 13=36, 15=20, 19=25, 20=35'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'2=7, 7=7, 11=7'"/>
    <xsl:variable name="inner_left_margin" select="'2=7, 7=7, 11=7'"/>
    <xsl:variable name="inner_top_margin" select="'2=30, 7=26, 11=37'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=50, 7=53, 11=23'"/>
