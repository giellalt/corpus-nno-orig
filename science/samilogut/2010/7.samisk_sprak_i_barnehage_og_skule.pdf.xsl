...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Samisk språk i barnehage og skule'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="7.samegiella_manaidgarddiin_ja_skuvllain_0.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 3-4, 6'"/>
    ...
    <xsl:variable name="top_margin" select="'7=20'"/>
    <xsl:variable name="bottom_margin" select="'2=43, 5=69, 7=66'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'2=30'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=55'"/>
