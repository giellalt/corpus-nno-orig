...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel_8_datagrunnlag_for_samisk_statistikk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Datagrunnlag for samisk statistikk'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="2_sami_statistics_data_source.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'2=23, 3=19, 4=27, 5=28, 6=24, 7=18'"/>
