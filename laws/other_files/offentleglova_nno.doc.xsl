...
<xsl:variable name="title" select="'LOV 2006-05-19 nr 16: Lov om rett til innsyn i dokument i offentleg verksemd (offentleglova).'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lahka-geassemanu-19-b-1970-almmolavuoa-birra-halddaeamis-almmolavuoalahka_id_420599.html" xml:lang="sme"/>
</xsl:variable>
